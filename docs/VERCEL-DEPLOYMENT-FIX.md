...
**Self-Signed SSL Certificate Error**: Connection to Supabase database failed with `SELF_SIGNED_CERT_IN_CHAIN` error because SSL certificate validation was too strict.
...
- [`docs/comprehensive-db-debug-guide.md`](./comprehensive-db-debug-guide.md) - Complete debugging guide
