...
All PWA icons are currently 93x88 pixels instead of their declared sizes in manifest.json. This
causes warnings in the browser console.
...
The icons will work even with incorrect sizes, but you'll see console warnings. The app will still
function normally.
