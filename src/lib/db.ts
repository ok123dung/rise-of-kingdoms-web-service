...
const CONNECTION_POOL_CONFIG = {
  ...
  connection_limit: parseInt(process.env.DATABASE_CONNECTION_LIMIT ?? '5', 10),
  ...
  idle_in_transaction_session_timeout: parseInt(process.env.DATABASE_IDLE_TIMEOUT ?? '10000', 10),
  // Statement timeout (ms)
  statement_timeout: parseInt(process.env.DATABASE_STATEMENT_TIMEOUT ?? '20000', 10)
}
