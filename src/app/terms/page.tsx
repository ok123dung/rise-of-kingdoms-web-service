              ...
              <div className="prose prose-lg max-w-none text-slate-700">
                ...
                <div className="bg-amber-50 p-6 rounded-xl border-l-4 border-amber-500 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-amber-800 mb-2">Lưu ý quan trọng</h3>
                      <p className="text-amber-700 mb-0">
                        Bằng cách sử dụng dịch vụ của RoK Services, bạn đồng ý tuân thủ và bị ràng buộc bởi 
                        các điều khoản và điều kiện sau đây. Nếu bạn không đồng ý với bất kỳ phần nào của 
                ...
                <div className="space-y-8">
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      <p>
                        <strong>"RoK Services"</strong> hoặc <strong>"Chúng tôi"</strong> có nghĩa là công ty 
                        cung cấp dịch vụ tư vấn và hỗ trợ chuyên nghiệp cho game Rise of Kingdoms.
                      </p>
                      <p>
                        <strong>"Khách hàng"</strong> hoặc <strong>"Bạn"</strong> có nghĩa là bất kỳ cá nhân 
                        hoặc tổ chức nào sử dụng dịch vụ của chúng tôi.
                      </p>
                      <p>
                        <strong>"Dịch vụ"</strong> bao gồm tất cả các loại hình tư vấn, hỗ trợ và dịch vụ 
                        liên quan đến Rise of Kingdoms được cung cấp bởi RoK Services.
                      </p>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      ...
                      <p>
                        Tất cả các dịch vụ được thực hiện thông qua các phương pháp hợp pháp và an toàn, 
                        không vi phạm Terms of Service của game Rise of Kingdoms.
                      </p>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      ...
                      <h3 className="text-lg font-semibold text-slate-900">5.2 Chính sách hoàn tiền</h3>
                      <ul className="list-disc pl-6 space-y-2">
                        <li>Hoàn tiền 100% nếu dịch vụ không được bắt đầu trong 24h sau thanh toán</li>
                        ...
                        <li>Hoàn tiền 100% nếu không đạt được KPI cam kết (áp dụng cho một số dịch vụ)</li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      <p>
                        RoK Services không chịu trách nhiệm trong các trường hợp sau:
                      </p>
                      <ul className="list-disc pl-6 space-y-2">
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      <p>
                        Chúng tôi có quyền chấm dứt dịch vụ trong các trường hợp:
                      </p>
                      <ul className="list-disc pl-6 space-y-2">
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      <ul className="list-disc pl-6 space-y-2">
                        <li>
                          <strong>Sửa đổi điều khoản:</strong> Chúng tôi có quyền cập nhật các điều khoản này. 
                          Khách hàng sẽ được thông báo qua email hoặc website ít nhất 7 ngày trước khi có hiệu lực.
                        </li>
                        <li>
                          <strong>Tính độc lập:</strong> Nếu bất kỳ điều khoản nào bị coi là không hợp lệ, 
                          các điều khoản còn lại vẫn có hiệu lực đầy đủ.
                        </li>
                        <li>
                          <strong>Ngôn ngữ:</strong> Phiên bản tiếng Việt của điều khoản này có giá trị pháp lý chính thức.
                        </li>
                        <li>
                          <strong>Liên hệ:</strong> Mọi thắc mắc về điều khoản vui lòng liên hệ support@rokdbot.com
                        </li>
                      </ul>
                    </div>
                  </section>
                ...
                <div className="mt-12 pt-8 border-t border-slate-200">
                  <div className="bg-slate-50 p-6 rounded-xl">
                    ...
                    <p className="text-slate-600 mb-4">
                      RoK Services cam kết cung cấp dịch vụ minh bạch, chất lượng và an toàn cho 
                      tất cả khách hàng. Chúng tôi luôn sẵn sàng lắng nghe và cải thiện dịch vụ 
