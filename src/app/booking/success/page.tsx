                ...
                <div className="container-max px-4">
                    <div className="mx-auto max-w-lg text-center">
                        ...
                        <p className="mb-8 text-lg text-gray-600">
                            Cảm ơn bạn đã tin tưởng RoK Services. Yêu cầu của bạn đã được ghi nhận.
                        ...
                        <div className="card mb-8 bg-white p-6 text-left shadow-sm">
                            ...
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-start space-x-3">
                                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs font-bold text-amber-600">1</span>
                                    <span>Kiểm tra email xác nhận (có thể trong mục Spam)</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs font-bold text-amber-600">2</span>
                                    <span>Chuẩn bị sẵn thông tin tài khoản/câu hỏi cần tư vấn</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs font-bold text-amber-600">3</span>
