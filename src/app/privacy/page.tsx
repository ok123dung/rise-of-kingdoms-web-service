                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mb-0 text-green-700">
                        ...
                        Chính sách này giải thích cách chúng tôi thu thập, sử dụng, lưu trữ và bảo
                        vệ thông tin của bạn khi sử dụng dịch vụ.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <section>
                    ...
                    <p className="mb-4">
                      ...
                      của bạn cho bên thứ ba vì mục đích thương mại. Thông tin chỉ được chia sẻ
                    ...
                    <h3 className="mb-3 text-lg font-semibold text-slate-900">
                      4.3 Sự đồng ý của bạn
                    </h3>
                    <p>
                      Trong mọi trường hợp khác, chúng tôi sẽ xin phép bạn trước khi chia sẻ thông
                      tin với bên thứ ba.
                    </p>
                  </section>
                  ...
                  {/* Section 5 */}
                  <section>
                    <h2 className="mb-4 text-2xl font-bold text-slate-900">5. Quyền của bạn</h2>
                    <p className="mb-4">Bạn có các quyền sau đối với thông tin cá nhân:</p>

                    <div className="mb-6 grid gap-6 md:grid-cols-2">
                      <div className="rounded-lg bg-amber-50 p-4">
                        <h4 className="mb-2 font-bold text-amber-800">🔍 Quyền truy cập</h4>
                        <p className="text-sm text-amber-700">
                          Yêu cầu xem thông tin cá nhân mà chúng tôi lưu trữ về bạn
                        </p>
                      </div>
                      <div className="rounded-lg bg-blue-50 p-4">
                        <h4 className="mb-2 font-bold text-blue-800">✏️ Quyền chỉnh sửa</h4>
                        <p className="text-sm text-blue-700">
                          Yêu cầu cập nhật hoặc sửa đổi thông tin không chính xác
                        </p>
                      </div>
                      <div className="rounded-lg bg-red-50 p-4">
                        <h4 className="mb-2 font-bold text-red-800">🗑️ Quyền xóa</h4>
                        <p className="text-sm text-red-700">
                          Yêu cầu xóa thông tin cá nhân (trong một số trường hợp)
                        </p>
                      </div>
                      <div className="rounded-lg bg-purple-50 p-4">
                        <h4 className="mb-2 font-bold text-purple-800">⛔ Quyền hạn chế</h4>
                  ...
                  <section>
                    ...
                    <h3 className="mb-3 text-lg font-semibold text-slate-900">6.2 Analytics</h3>
                    <p className="mb-4">
                      Chúng tôi sử dụng Google Analytics để hiểu cách khách hàng sử dụng website (dữ
                      liệu được ẩn danh). Bạn có thể opt-out bằng cách cài đặt Google Analytics
                    ...
                    <p>
                      Bạn có thể quản lý tùy chọn cookies thông qua cài đặt trình duyệt hoặc banner
                      cookies trên website của chúng tôi.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <ul className="mb-4 list-disc space-y-2 pl-6">
                      ...
                      <li>
                        <strong>Lịch sử dịch vụ:</strong> 3 năm sau khi hoàn thành
                      </li>
                      <li>
                        <strong>Thông tin thanh toán:</strong> 5 năm (theo quy định pháp luật)
                      </li>
                      <li>
                        <strong>Logs và analytics:</strong> 1 năm
                      </li>
                    </ul>
                    ...
                    <p>
                      Hệ thống sẽ tự động xóa dữ liệu hết hạn và thông báo cho bạn trước khi xóa dữ
                      liệu quan trọng.
                    </p>
                  </section>
                    ...
                    <div className="rounded-xl border-l-4 border-orange-500 bg-orange-50 p-6">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mb-0 text-orange-700">
                            Nếu bạn là phụ huynh và phát hiện con mình đã cung cấp thông tin cho
                            chúng tôi, vui lòng liên hệ để chúng tôi xóa thông tin đó.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <section>
                    ...
                    <p className="mb-4">
                      Chúng tôi có thể cập nhật chính sách bảo mật này định kỳ để phản ánh những
                      thay đổi trong dịch vụ hoặc luật pháp.
                    </p>
                    <ul className="list-disc space-y-2 pl-6">
                  ...
                  {/* Section 10 */}
                  <section>
                    <h2 className="mb-4 text-2xl font-bold text-slate-900">10. Liên hệ</h2>
                    <p className="mb-4">
                      Nếu bạn có bất kỳ câu hỏi nào về chính sách bảo mật này hoặc cách chúng tôi xử
                      lý thông tin cá nhân của bạn, vui lòng liên hệ:
                    </p>
                      ...
                      <div className="grid gap-6 md:grid-cols-2">
                        <div>
                          <h4 className="mb-2 font-bold text-slate-900">
                            📧 Email chuyên về bảo mật
                          </h4>
                          <p className="text-slate-600">privacy@rokdbot.com</p>
                        </div>
                        <div>
                          <h4 className="mb-2 font-bold text-slate-900">📞 Hotline hỗ trợ</h4>
                          <p className="text-slate-600">0987.654.321</p>
                        </div>
                        <div>
                          <h4 className="mb-2 font-bold text-slate-900">📬 Địa chỉ</h4>
                          <p className="text-slate-600">Hà Nội, Việt Nam</p>
                        </div>
                        <div>
                          <h4 className="mb-2 font-bold text-slate-900">⏰ Thời gian phản hồi</h4>
                ...
                <div className="mt-12 border-t border-slate-200 pt-8">
                  <div className="rounded-xl bg-green-50 p-6">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row">
                      ...
                      <a className="btn-secondary text-center" href="/terms">
