      ...
      <div className="mx-auto max-w-3xl border border-gray-200 p-8 print:border-0">
        ...
        <div className="mb-8 grid grid-cols-2 gap-8">
          <div>
            ...
            <p className="font-medium">{booking.user.fullName || booking.user.email}</p>
          ...
          <div className="text-right">
            ...
            <p className="text-sm">
              ...
              {format(booking.createdAt, 'dd/MM/yyyy', { locale: vi })}
            </p>
            <p className="text-sm">
        ...
        <table className="mb-8 w-full">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-4">
                <p className="font-medium">{booking.serviceTier.service.name}</p>
                <p className="text-sm text-gray-500">{booking.serviceTier.name}</p>
              </td>
