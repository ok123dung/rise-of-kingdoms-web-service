...
export function VietnameseGamingSchema() {
  const organizationData = {
    ...
    description: "Dịch vụ Rise of Kingdoms chuyên nghiệp tại Việt Nam - Tư vấn chiến thuật, quản lý liên minh, training commander",
  ...
  const serviceData = {
    ...
    description: "Tư vấn chiến thuật, quản lý liên minh, training commander cho game Rise of Kingdoms tại Việt Nam",
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Có! Chúng tôi hướng dẫn farm gem an toàn 4-20k gems/ngày tùy theo gói dịch vụ. Phương pháp được kiểm chứng qua 500+ khách hàng thành công."
    },
    {
...
export function VietnameseKeywordsOptimization() {
  const keywordSchema = {
    ...
    "description": "Dịch vụ Rise of Kingdoms hàng đầu Việt Nam: tư vấn chiến thuật RoK, farm gem, build commander, quản lý liên minh. Tăng power 100-200% an toàn.",
    "keywords": [
    ...
    "review": [
      {
        ...
        "reviewBody": "Dịch vụ tư vấn chiến thuật rất chuyên nghiệp. Power tăng từ 50M lên 120M chỉ trong 2 tháng!"
      }
    ],
    "aggregateRating": {
...
export function GamingBreadcrumbSchema({ 
  items 
}: { 
